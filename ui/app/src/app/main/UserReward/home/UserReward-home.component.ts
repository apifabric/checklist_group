...
@Component({
  selector: 'UserReward-home',
  templateUrl: './UserReward-home.component.html',
  styleUrls: ['./UserReward-home.component.scss']
})
export class UserRewardHomeComponent implements AfterViewInit {
