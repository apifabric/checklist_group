...
@Component({
  selector: 'TaskHistory-home',
  templateUrl: './TaskHistory-home.component.html',
  styleUrls: ['./TaskHistory-home.component.scss']
})
export class TaskHistoryHomeComponent implements AfterViewInit {
