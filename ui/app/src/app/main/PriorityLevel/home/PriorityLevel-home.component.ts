...
@Component({
  selector: 'PriorityLevel-home',
  templateUrl: './PriorityLevel-home.component.html',
  styleUrls: ['./PriorityLevel-home.component.scss']
})
export class PriorityLevelHomeComponent implements AfterViewInit {
