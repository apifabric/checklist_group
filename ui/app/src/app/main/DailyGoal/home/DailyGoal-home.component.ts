...
@Component({
  selector: 'DailyGoal-home',
  templateUrl: './DailyGoal-home.component.html',
  styleUrls: ['./DailyGoal-home.component.scss']
})
export class DailyGoalHomeComponent implements AfterViewInit {
