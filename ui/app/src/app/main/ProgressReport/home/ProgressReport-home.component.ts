...
@Component({
  selector: 'ProgressReport-home',
  templateUrl: './ProgressReport-home.component.html',
  styleUrls: ['./ProgressReport-home.component.scss']
})
export class ProgressReportHomeComponent implements AfterViewInit {
